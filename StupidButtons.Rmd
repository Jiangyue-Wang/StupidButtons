...
summary(MNTDlm1)
#not significant
MNTDlm2 <-update(MNTDlm1,.~.+Elevation)
MPDlm1 <- lm(MPD~Elevation*forest,data=diversity)
summary(MPDlm1)
#not significant
hist(diversity$shannon)
shannonlm1 <- lm(shannon~Elevation*forest,data=diversity)
summary(shannonlm1)
#not significant
indlm1 <- lm(No.ind~Elevation*forest, data=diversity)
summary(indlm1)
check_model(indlm1) # wrong!!!

indlm2 <- glm(No.ind~Elevation*forest, data=diversity, family = "poisson")
summary(indlm2)
check_model(indlm2)
indlm3 <- glm(No.ind~Elevation, data=diversity, family = "poisson")
summary(indlm3)
check_model(indlm3)
AIC(indlm2,indlm3) # Although AIC lower, indlm3 diagnostic better


PDlm1 <- lm(PD~Elevation*forest, data=diversity)
summary(PDlm1)
PDlm2 <- lm(PD~Elevation, data=diversity)
summary(PDlm2)
AIC(PDlm1,PDlm2)
anova(PDlm1,PDlm2)
#just keep elevation

richnesslm1 <- lm(richness~Elevation*forest, data=diversity)
summary(richnesslm1)
#not significant
check_model(richnesslm1)
richnesslm2 <- glm(richness~Elevation*forest, data=diversity, family = "poisson")
summary(richnesslm2)
#not significant
```
Significant models: FDiv~Elevation+forest+Elevation:forest,
